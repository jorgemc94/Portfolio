...
export const proyectosData = {
    proyectos: [
        ...
        {
            proyecto: "Miranda Dashboard",
            descripción: 'Aplicación de gestión para empleados de hotel para manejar reservas, habitaciones y usuarios. Incluye front-end, back-end y base de datos.',
            stack: [
                {
                    "name": "Express",
